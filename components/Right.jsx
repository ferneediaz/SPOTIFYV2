...
function Right({ chooseTrack, spotifyApi }) {
  ...
  return (
    <section className="p-4 space-y-8 pr-8 flex-grow">
    <div className="flex items-center justify-between">
      {/* Icons */}
      <div className="flex items-center inline-block space-x-4 border-2 border-[#262626] rounded-full h-12 py-3 px-4">
    ...
    {/* Recently Played Tracks */}
    <div className="bg-[#0D0D0D] border-2 border-[#262626] p-4 rounded-xl space-y-4 flex-grow">
      <div className="flex items-center justify-between">
